...
"""Script to run the pypd testsuite."""
...
def make_test_suite():
    """Load unittests placed in pypd/tests/unittests, then return a
    TestSuite object of those."""
    # [...]/pypd/pypd [cut] /tests/runtests.py
    path = os.path.abspath(__file__).rsplit(os.sep+'tests', 1)[0]

    sys.path.append(path.rstrip('pypd'))
    ...
    for testdir in testdirs:
        ...
        # found
        test_package_path = 'pypd.tests.unittests'
